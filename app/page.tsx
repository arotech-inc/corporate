        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-5 mb-20 text-left">
          ...
          <div className="relative bg-zinc-900/80 border border-white/10 rounded-2xl p-8 overflow-hidden">
            ...
            <div className="absolute top-6 right-6">
              <Image src="/vision_icon1.png" alt="시스템 중심 설계" width={100} height={100} />
            </div>
          ...
          <div className="relative bg-zinc-900/80 border border-white/10 rounded-2xl p-8 overflow-hidden">
            ...
            <div className="absolute top-6 right-6">
              <Image src="/vision_icon2.png" alt="플레이어 경험 우선" width={100} height={100} />
            </div>
          ...
          <div className="relative bg-zinc-900/80 border border-white/10 rounded-2xl p-8 overflow-hidden">
            ...
            <div className="absolute top-6 right-6">
              <Image src="/vision_icon3.png" alt="빠른 실행, 빠른 검증" width={100} height={100} />
            </div>
